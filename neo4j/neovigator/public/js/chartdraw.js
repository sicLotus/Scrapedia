...
function callTop20Linked() {
    ...
    $.ajax({
        url: "http://ec2-54-246-66-235.eu-west-1.compute.amazonaws.com:8088/statistics/top20/mostlinked",
        dataType: "text",
...
function callTop20Links() {
    ...
    $.ajax({
        url: "http://ec2-54-246-66-235.eu-west-1.compute.amazonaws.com:8088/statistics/top20/mostlinks",
        dataType: "text",
...
function appendNotLinkedList() {
    ...
    $("#content").append($('<p class="wait">Please wait...</p>'));
    $.ajax({
        url: "http://ec2-54-246-66-235.eu-west-1.compute.amazonaws.com:8088/statistics/list/unlinked",
        success: function (data) {
            if (data) {
                $("#content").empty();
...
function appendNoLinks() {
    ...
    $("#content").append($('<p class="wait">Please wait...</p>'));
    $.ajax({
        url: "http://ec2-54-246-66-235.eu-west-1.compute.amazonaws.com:8088/statistics/list/nolinks",
        success: function (data) {
            if (data) {
                $("#content").empty();
